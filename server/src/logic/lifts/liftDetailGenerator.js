...
export function generateLiftDetails(profile, lift) {
...
function selectExercise(preferredExercises, defaultExercises) {
...
// Core Exercises
const antiExtensionCoreExercises = [
...
const antiRotationCoreExercises = [
...
const antiLateralFlexionCoreExercises = [
...
const trunkFlexionCoreExercises = [
